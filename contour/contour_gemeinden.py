...
for feature1 in layer1:
    ...
    for feature2 in layer2:
        ...
        if geom2.Intersects(geom1): 
            ...
            #outfile = os.path.join(TMP_PATH, "contour_" + str(int(gem_bfs)), "contour_" + str(int(gem_bfs)) + ".shp")
            outfile = os.path.join(TMP_PATH, "contour_" + str(int(gem_bfs)) + ".shp")
            cmd = "/usr/local/gdal/gdal-dev/bin/ogr2ogr -append -clipsrc" 
